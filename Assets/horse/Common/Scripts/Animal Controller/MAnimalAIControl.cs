      ...
      //  public bool NullDestination => DestinationPosition == NullVector;
        ...
        public virtual void SetNextTarget()
        {
            ...
            if (IsWayPoint != null)
            {
                ...
                if (IsWayPoint.WaitTime == 0)
                {
                    Debuging("New Next Target");
        ...
        {
            if (IsWayPoint != null && IsWayPoint.PointType == WayPointType.Air)    //If the animal can fly, there's a new wayPoint & is on the Air
            {
        ...
        private void Arrive_Destination()
        {
            ...
            Debuging("has arrived to Destination");
            ...
            {
                if (IsWayPoint.PointType == WayPointType.Ground) FreeMove = false; //if the next waypoing is on the Ground then set the free Movement to false
        ...
        void OnDrawGizmos()
        {
            ...
            {
                if (IsWayPoint != null && IsWayPoint.PointType == WayPointType.Air)
