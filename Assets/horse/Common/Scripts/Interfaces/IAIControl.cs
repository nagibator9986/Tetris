...
namespace MalbersAnimations 
{
    ...
    public interface IAITarget
    {
        ...
        ///// <summary>Gets the World Center Position of the AITarget</summary>
        //Vector3 Center { get; set; }

        ///// <summary>Set the Local Center of the AITarget</summary>
        //void SetLocalCenter(Vector3 localCenter);
    }
}
