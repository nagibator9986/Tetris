...
namespace MalbersAnimations.Utilities
{
    public class Aim : MonoBehaviour, IAim, IAnimatorListener
    {
        ...
        private LayerMask m_aimLayer = -1;
        ...
        public LayerMask AimLayer { get => m_aimLayer; private set => m_aimLayer = value; }
        ...
        public void DirectionFromCamera(Vector3 ScreenPoint, out RaycastHit hit, Transform Ignore = null)
        {
            ...
            //else
            int hitcount = Physics.RaycastNonAlloc(ray, Hits, RayLength, AimLayer, m_Triggers);
